...
// Classe Electronic qui étend la classe AbstractProduct
class Electronic extends AbstractProduct
{
    ...
    public function findOneById(int $id): Electronic|false
    {
        try {
            ...
            // Créer une instance de électronique avec toutes les données
    ...
    // Surcharge de la méthode findAll pour renvoyer un tableau d'instances de Electronic
    ...
    // Implémentation de la méthode abstraite create pour inclure les données spécifiques aux électroniques
    ...
    // Implémentation de la méthode abstraite update pour inclure les données spécifiques aux électroniques
